...
namespace kasadigital\modules\UserManagement\models\search;
...
/**
 * UserVisitLogSearch represents the model behind the search form about `kasadigital\modules\UserManagement\models\UserVisitLog`.
 */
